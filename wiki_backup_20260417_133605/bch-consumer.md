...
`bch-consumer` is a JavaScript library used as an interface for Web 3 infrastructure in the [Cash Stack](cash-stack-layers.md) (source: [minimal-slp-wallet](minimal-slp-wallet.md).md).
