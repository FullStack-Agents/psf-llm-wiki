...
### Full Nodes
Full nodes maintain a complete, up-to-date copy of the [blockchain](blockchain.md). This allows them to verify any transaction authoritatively without relying on external sources (source: mastering-bitcoin-cash_chapter-5-the-bitcoin-cash-network_2.md).

### Lightweight (SPV) Nodes
Lightweight nodes use **Simplified Payment Verification (SPV)** and only store a subset of the [blockchain](blockchain.md). These are typically used on resource-constrained devices like smartphones (source: mastering-bitcoin-cash_chapter-5-the-bitcoin-cash-network_2.md).
