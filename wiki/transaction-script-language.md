...
**Summary**: The stack-based, non-Turing-complete language used to define locking and unlocking conditions in [[bitcoin-cash](bitcoin-cash.md)](bitcoin-cash.md).
...
The [[bitcoin-cash](bitcoin-cash.md)](bitcoin-cash.md) script language is a Forth-like, stack-based language used to implement the conditions required to spend [utxo](utxo.md)s (source: mastering-bitcoin-cash_transactions_8.md).
