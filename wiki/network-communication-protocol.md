...
**Summary**: The message-based communication system used by [[bitcoin-cash](bitcoin-cash.md)](bitcoin-cash.md) nodes to propagate blocks, transactions, and headers.
...
The [[bitcoin-cash](bitcoin-cash.md)](bitcoin-cash.md) network operates on a request-response communication protocol that prioritizes efficiency and backward compatibility.
