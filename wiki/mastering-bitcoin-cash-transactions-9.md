...
**Summary**: Overview of the five standard transaction types accepted by the [Bitcoin Cash](bitcoin-cash.md) reference client, including P2PKH, P2PK, Multi-Signature, Data Outputs, and P2SH.
...
The [Bitcoin Cash](bitcoin-cash.md) reference client accepts five standard transaction types (source: mastering-bitcoin-cash_transactions_9.md):

### 1. Pay-to-Public-Key-Hash (P2PKH)
This is the most common transaction type. It encumbers the output with a [public key](addresses.md) hash, which corresponds to a [Bitcoin Cash](bitcoin-cash.md) [address](addresses.md).
...
Used to store up to 220 bytes of non-payment data. These outputs are provably unspendable and are not stored in the [UTXO](utxo.md) set.
