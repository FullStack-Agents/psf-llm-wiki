...
**Summary**: The mechanism for compensating miners and preventing spam in Bitcoin Cash.
...
- **Incentives**: Fees reward [[mining]] nodes for securing the network and discourage the broadcasting of spam transactions (source: mastering-bitcoin-cash_transactions_6.md).
...
### Warning on Change
Failure to create a change output for the unused portion of a consumed [[utxo]] will result in that remaining balance being collected as a fee by the miner (source: mastering-bitcoin-cash_transactions_6.md).
