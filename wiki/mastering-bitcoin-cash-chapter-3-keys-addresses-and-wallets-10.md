...
**Summary**: This document explains Pay-to-Script-Hash (P2SH) addresses and multi-signature (multi-sig) configurations, allowing for complex spending conditions beyond a single [public key](addresses.md) owner.
...
To create a P2SH [address](addresses.md), the same double-hash function (SHA256 followed by RIPEMD160) is applied to a script instead of a [public key](addresses.md).

### Multi-Signature (Multi-sig)
The most common use of P2SH is the **multi-signature** [address](addresses.md), which requires a specific number of signatures from a set of available keys to authorize a spend.
