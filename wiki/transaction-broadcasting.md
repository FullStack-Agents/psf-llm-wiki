...
Broadcasting requires delivering a transaction to any [Bitcoin Cash](bitcoin-cash.md) node to ensure it is propagated and eventually included in the blockchain (source: mastering-bitcoin-cash_transactions_2.md).
