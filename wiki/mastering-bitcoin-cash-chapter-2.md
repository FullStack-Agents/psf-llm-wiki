...
1. **Users** utilize [[digital-wallets]] and cryptographic keys to initiate transactions.
...
It also explains the **construction process**, highlighting the role of [[utxo]] (Unspent Transaction Outputs) as the source of funds and how wallets query the network to identify available outputs to serve as transaction inputs (source: mastering-bitcoin-cash_chapter-2-how-bicoin-cash-works_3.md).
...
The chapter explores the competitive nature of [[mining]], describing the use of the SHA256 algorithm to solve cryptographic puzzles and the transition from CPU-based mining to the use of specialized ASIC hardware and mining pools (source: mastering-bitcoin-cash_chapter-2-how-bicoin-cash-works_5.md).
...
The chapter introduces [[blockchain-explorers]] as the primary tools for users to interact with the ledger, providing a transparent way to verify transactions, balances, and block details without needing to run a full node (source: mastering-bitcoin-cash_chapter-2-how-bicoin-cash-works_10.md).
