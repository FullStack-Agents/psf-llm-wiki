...
## P2SH Addresses
P2SH addresses use Base58Check encoding with a prefix of "5", meaning they typically start with the character "3". This allows complex scripts to have a standard [address](addresses.md) format (source: mastering-bitcoin-cash_transactions_10.md).
