...
4. **Odd Number Handling**: If there is an odd number of transactions, the last transaction hash is duplicated to ensure a balanced binary tree (source: mastering-bitcoin-cash_chapter-6-the-[blockchain](blockchain.md)_4.md).
