# Mastering Bitcoin Cash Chapter 5 Part 6
...
SPV nodes face a privacy challenge: requesting specific transactions from peers can reveal the addresses in the node's wallet to third parties (source: mastering-bitcoin-cash_chapter-5-the-bitcoin-cash-network_6.md). To mitigate this, Bitcoin Cash uses **Bloom Filters**.
...
**Adding a Pattern:**
1. The pattern (e.g., a wallet address) is processed by each hash function.
