...
**Summary**: Description of the Bitcoin Cash transaction data structure and the function of the locktime field.
...
A Bitcoin Cash transaction is a data structure consisting of the following fields:
