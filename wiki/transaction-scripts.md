...
**Summary**: The locking and unlocking scripts used to secure and spend [[bitcoin-cash](bitcoin-cash.md)](bitcoin-cash.md) outputs.
...
### Unlocking Scripts
To spend a [[utxo](utxo.md)](utxo.md), a transaction input must provide an **unlocking script**. This script must satisfy the conditions defined by the corresponding locking script to authorize the transfer of funds (source: mastering-bitcoin-cash_transactions_5.md).
