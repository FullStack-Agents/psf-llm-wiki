...
**Summary**: How [[bitcoin-cash](bitcoin-cash.md)](bitcoin-cash.md) nodes discover, maintain, and bootstrap connections to other peers.
...
Nodes in the [[bitcoin-cash](bitcoin-cash.md)](bitcoin-cash.md) network manage their connections to ensure diverse paths into the network and reliable connectivity.
