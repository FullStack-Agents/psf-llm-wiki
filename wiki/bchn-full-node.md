...
**Summary**: The base layer of the [Cash Stack](cash-stack-layers.md), providing the essential blockchain node software that validates transactions and blocks on the [Bitcoin Cash](bitcoin-cash.md) ([BCH](bitcoin-cash.md)) network.
...
The full node serves as the source of truth for the blockchain. Other layers of the [Cash Stack](cash-stack-layers.md), such as indexers and the [psf-bch-api]([psf-bch-api](psf-bch-api.md).md), depend on the full node to perform actual transactions and provide direct access to the blockchain data (source: bchn-full-node.md).
