...
[blockchain](blockchain.md) explorers are transparent windows into the complex cryptographic ledger of [bitcoin-cash](bitcoin-cash.md), allowing users to navigate the [blockchain](blockchain.md) without needing specialized software (source: mastering-bitcoin-cash_chapter-2-how-bicoin-cash-works_10.md).
